...
activity_5 = Activity("Axe Throwing", 12, True, "2021-07-02", "13:00")
activity_repository.add(activity_5)
activity_6 = Activity("Powerlifting", 10, False, "2021-07-31", "21:00")
activity_repository.add(activity_6)
activity_7 = Activity("Deadlifts", 4, True, "2021-08-07", "16:00")
activity_repository.add(activity_7)
activity_8 = Activity("Strength", 8, False, "2021-07-31", "09:00")
