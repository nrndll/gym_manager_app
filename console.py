...
member_5 = Member("Carl", "Weathers", True)
member_repository.add(member_5)
member_6 = Member("Dolph", "Lundgren", False)
member_repository.add(member_6)
member_7 = Member("Sylvester", "Stallone", False)
member_repository.add(member_7)
...
activity_2 = Activity("Powerlifting", 10, False, "2021-07-31", "21:00")
activity_repository.add(activity_2)
activity_3 = Activity("Deadlifts", 4, True, "2021-07-31", "16:00")
activity_repository.add(activity_3)
activity_4 = Activity("Strength", 8, False, "2021-08-01", "09:00")
activity_repository.add(activity_4)
activity_5 = Activity("Axe Throwing", 12, True, "2021-08-01", "13:00")
activity_repository.add(activity_5)
activity_6 = Activity("Powerlifting", 10, False, "2021-08-01", "21:00")
activity_repository.add(activity_6)
activity_7 = Activity("Deadlifts", 4, True, "2021-08-01", "16:00")
activity_repository.add(activity_7)
activity_8 = Activity("Strength", 8, False, "2021-08-02", "09:00")
activity_repository.add(activity_8)
