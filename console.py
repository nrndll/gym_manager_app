...
activity_1 = Activity("Axe Throwing", 12, True, "11/07/21", "13:00")
activity_repository.add(activity_1)
activity_2 = Activity("Powerlifting", 10, False, "19/07/21", "21:00")
activity_repository.add(activity_2)
activity_3 = Activity("Deadlifts", 4, True, "31/07/21", "16:00")
activity_repository.add(activity_3)
activity_4 = Activity("Strength", 8, False, "01/08/21", "09:00")
...
# print(activity_repository.capacity(2))
